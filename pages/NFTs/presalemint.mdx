...
The `/collections/presaleMint` API allows for the minting of NFTs during the presale phase of a specific NFT collection. This endpoint requires the following request parameters and provides the corresponding response.
