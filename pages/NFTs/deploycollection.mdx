...
The `/collections/deploy` API is used to deploy a new collection of NFTs. This endpoint requires the following request parameters and provides the corresponding response.
